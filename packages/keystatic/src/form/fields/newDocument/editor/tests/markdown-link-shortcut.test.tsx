...
/** @jsxRuntime classic */
/** @jsx jsx */
import { createTestEditorNodes, jsx, renderEditor, undo } from './utils';
...
test("link shortcut doesn't do anything when links are disabled globally in the editor", async () => {
  const n = createTestEditorNodes(
    {
      formatting: {
