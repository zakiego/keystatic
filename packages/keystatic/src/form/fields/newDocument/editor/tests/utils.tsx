import { DocumentFeaturesConfig, normaliseDocumentFeatures } from '../..';
...
export function createTestEditorNodes(
  documentFeaturesConfig: DocumentFeaturesConfig,
  componentBlocks: Record<string, ComponentBlock>
) {
  const { nodes } = createEditorSchema(
    normaliseDocumentFeatures(documentFeaturesConfig),
    componentBlocks
  );
  return nodes as typeof nodes & {
    [Key in keyof typeof nodes]: Key extends keyof jsx.JSX.IntrinsicElements
      ? (props: jsx.JSX.IntrinsicElements[Key]) => EditorStateDescription
      : unknown;
  };
}
